	...
	public class ModedPlayer : ModPlayer
	{
      ...
      BalloonMaxBuff = false;
		...
		public override void clientClone(ModPlayer clientClone) {
			ModedPlayer clone = clientClone as ModedPlayer;
		...
		public override void SyncPlayer(int toWho, int fromWho, bool newPlayer) {
			...
			packet.Write((byte)ExampleModMessageType.ModedPlayerSyncPlayer);
		...
		public override void SendClientChanges(ModPlayer clientPlayer) {
			...
			ModedPlayer clone = clientPlayer as ModedPlayer;
		...
		public override bool CustomBiomesMatch(Player other) {
			ModedPlayer modOther = other.GetModPlayer<ModedPlayer>();
		...
		public static readonly PlayerLayer MiscEffectsBack = new PlayerLayer("ExampleMod", "MiscEffectsBack", PlayerLayer.MiscEffectsBack, delegate (PlayerDrawInfo drawInfo) {
			...
			ModedPlayer modPlayer = drawPlayer.GetModPlayer<ModedPlayer>();
