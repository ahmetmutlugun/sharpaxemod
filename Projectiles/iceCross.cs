...
namespace sharpaxemod.Projectiles
{
    ...
    public class iceCross : ModProjectile
    {
        ...
        public override void AI(){
          ...
          // if (Main.rand.Next(5) == 0){ //20% of the time
          ...
          //
          // // Spawn the dust
          // Dust.NewDust(projectile.position, projectile.width, projectile.height, choice, projectile.velocity.X * 0.25f, projectile.velocity.Y * 0.25f, 150, , 0.7f);
